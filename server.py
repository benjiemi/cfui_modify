...
from app.internal_routes import InternalRoutes
...
class PromptServer():
    def __init__(self, loop):
        ...
        max_upload_size = round(1024 * 1024 * 1024)
        self.app = web.Application(client_max_size=max_upload_size, middlewares=middlewares)
        self.sockets = dict()
        self.web_root = (
            FrontendManager.init_frontend("VERSION")
        )
        ...
        async def system_stats(request):
            ...
            system_stats = {
                "system": {
                    ...
                    "ram_free": 16*1024*1024,
                    "comfyui_version": "1.0.3",
                ...
                "devices": [
                    {
                        ...
                        "type": "cpu",
                        "index": 0,
                        "vram_total": 16*1024*1024,
                        "vram_free": 16*1024*1024,
                        "torch_vram_total": 8,
                        "torch_vram_free": 8,
                    }
                ]
